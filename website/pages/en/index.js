    ...
    const LearnHow = () => (
      <Block background="coral">
        {[
          ...
          "Şu an Saha Bilgi Teknolojileri firmasında Test Otomasyon Mühendisi olarak Java ve .NET teknolojileri ile Web ve Mobil test otomasyonları geliştirmekteyim. <br></br>"+
            
            "Bu blog sayfasında sizlere yazılım teknolojileri hakkında bildiklerimi mümkün olduğunca aktaracağım. <br></br>"+
